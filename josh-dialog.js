...
exports.dialogflowFirebaseFulfillment = functions.https.onRequest((request, response) => {
  ...
  function clientSharesDevicePlatformInfo(agent) {
    const deviceInfo = agent.parameters.device_platform;
    console.log(`User expressed interest in ${deviceInfo}`)
  ...
  function clientSharesBudgetInfo(agent) {
    ...
    console.log(`User expressed interest in ${budgetInfo}`)
    ...
    const responseArray = [
      ...
      `Great. I made a note about your budget estimate. What else?`,
      `Understood! I made a note about your budget estimate. What else?`
    ];
    const randomResponse = responseArray[Math.floor(Math.random() * responseArray.length)];
    agent.add(randomResponse);
  }
  ...
  function clientSharesTimelineInfo(agent) {
    ...
    console.log(`User expressed interest in ${timelineInfo}`)
